...
class Order(models.Model):
    customer_user = models.EmailField(blank=True, null=True, default=None)
    ...
    def __str__(self):
        return " Order ticket %s  %s" % (self.id, self.status.name)
...
class ProductInOrder(models.Model):
    ...
    class Meta:
        verbose_name = 'Your ticket'
        verbose_name_plural = 'Your tickets'
